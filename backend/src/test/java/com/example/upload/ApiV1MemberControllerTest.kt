...
class ApiV1MemberControllerTest @Autowired constructor(
    ...
    private fun checkMember(resultActions: ResultActions, member: Member) {
        resultActions
            ...
            .andExpect(jsonPath("$.data.profileImgUrl").value(member.profileImgUrlOrDefaultUrl))
    }
    ...
    fun login1() {
        ...
        resultActions
            ...
            .andExpect(jsonPath("$.data.item.profileImgUrl").value(member.profileImgUrlOrDefaultUrl))
